...
app.get("/", (request, response) => {//Lord Creative
  console.log(Date.now() + "İnternal  7/24 AKTİF TUTMA İŞLEMİ BAŞARILI");//Lord Creative
      ...
      try {
        if (!msg.member.hasPermission("MANAGE_GUILD")) {
          ...
          let embed = new Discord.RichEmbed()
            .setColor(0xffa300)
            .setFooter(
              "İnternal BOT  -|-  Reklam engellendi.",
...
client.on("message", async message => {
    ...
    if (command === "sunucu-kur") {
      ...
      message.channel
        ...
        message.guild
            .createChannel("🌀booster-avantaj", "text", [
              {
                id: message.guild.id,
                deny: ["SEND_MESSAGES"]
              }
        ...
        message.guild
            .createChannel(`🔤kelime-türetmece`, "text")
            .then(channel =>
              channel.setParent(
                message.guild.channels.find(
                  channel => channel.name === "||GENEL KANALLAR||"
          ...
          message.guild
            .createChannel(`💡öneri-şikayet`, "text")
            .then(channel =>
              channel.setParent(
                message.guild.channels.find(
                  channel => channel.name === "||GENEL KANALLAR||"
          ...
          message.guild
            .createChannel(`🎮BRAWL STARS🎮`, "voice")
            .then(channel =>
              channel.setParent(
                message.guild.channels.find(
                  channel => channel.name === "||OYUN ODALARI||"
...
//Lord Creative
          message.channel.send("Gerekli Odaları Kurdum! Şimdi Kanallara Göz Atabilirsin!");
        });
    }
  });
//Lord Creative